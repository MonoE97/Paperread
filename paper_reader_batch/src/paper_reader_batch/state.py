...
from paper_reader_batch.io import JsonFileError, read_json
from paper_reader_batch.manifest import ZOTERO_WRITE_POLICY
from paper_reader_batch.takeaway import TakeawayError, extract_takeaway


STATE_SCHEMA_VERSION = "paper_reader_batch.state.v1"
ITEM_RESULT_SCHEMA_VERSION = "paper_reader_batch.item-result.v1"
WRITE_RESULT_SCHEMA_VERSION = "paper_reader_batch.write-result.v1"
LOCAL_PREPARE_RESULT_SCHEMA_VERSION = "paper_reader_batch.local-prepare-result.v1"
...
def _validate_success_result(result: dict[str, Any], manifest_item: dict[str, Any]) -> dict[str, str]:
    normalized: dict[str, str] = {
        "paper_reader_run_dir": _require_directory(result.get("paper_reader_run_dir"), "paper_reader_run_dir"),
        ...
        selected.append(
            {
                ...
                "paper_reader_run_dir": state_item.get("paper_reader_run_dir", ""),
