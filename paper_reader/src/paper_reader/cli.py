...
from paper_reader.gate import build_gate_report
from paper_reader.local_candidate import prepare_local_note_candidate
from paper_reader.local_gate import build_local_gate_report
from paper_reader.note import build_note_labels, render_note, render_note_html, validate_note, validate_trusted_summary
...
from paper_reader.pdf_workflow import allocate_pdf_output_paths, validate_pdf_readable
from paper_reader.review import apply_review_to_summary
from paper_reader.runs import allocate_run_dir, write_run_manifest
from paper_reader.summary_lint import lint_summary
from paper_reader.workflow import prepare_item_bundle, prepare_pdf_bundle
from paper_reader.write_candidate import prepare_write_candidate
from paper_reader.write_payload import build_write_payload
...
def refresh_live_notes_command(
    ...
    typer.echo(json.dumps(refreshed["_paper_reader"]["enrichment"]["live_notes"], ensure_ascii=False))
